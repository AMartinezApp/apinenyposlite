/**
 * =================================================================
 * Validating Credit Entry Detail
 * =================================================================
...
const validatorCreateCreditEntryDetail = [
  check("idcreditentry").exists().notEmpty().isNumeric(),
...
const validatorIdCreditEntryDetail = [
...
module.exports = { validatorCreateCreditEntryDetail, validatorIdCreditEntryDetail };
